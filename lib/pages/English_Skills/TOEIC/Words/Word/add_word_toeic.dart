...
class AddWordToeic extends StatefulWidget {
  final String level;  // レベルを動的に渡す

  const AddWordToeic({super.key, required this.level});

  @override
  _AddWordToeicState createState() => _AddWordToeicState();
}

class _AddWordToeicState extends State<AddWordToeic> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add Word for TOEIC ${widget.level}'),
      ),
      body: Form(
        key: _formKey,
